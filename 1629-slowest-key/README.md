...
<pre style="position: relative;"><strong>Input:</strong> releaseTimes = [9,29,49,50], keysPressed = "cbcd"
...
<pre style="position: relative;"><strong>Input:</strong> releaseTimes = [12,23,36,46,62], keysPressed = "spuda"
...
The longest of these was the keypress for 'a' with duration 16.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
